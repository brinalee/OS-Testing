...
all: main memory pageFault filesys seqFileRead randFileRead seqRemoteFileRead randRemoteFileRead
...
clean:
	rm *.o main memory pageFault filesys seqFileRead randFileRead seqRemoteFileRead randRemoteFileRead
